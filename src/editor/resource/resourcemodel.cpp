...
bool ResourceModel::canDropMimeData(const QMimeData *data, Qt::DropAction action, int row, int column,
...
bool ResourceModel::dropMimeData(const QMimeData *data, Qt::DropAction action, int row, int column,
