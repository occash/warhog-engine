...
Matrix4 Matrix4::operator*(const Matrix4& other) const
{
    ...
    result1 = _mm256_add_ps(result1, _mm256_mul_ps(_mm256_shuffle_ps(m01, m01, 0x55),
                            _mm256_broadcast_ps(&other.row[1].data)));
    result1 = _mm256_add_ps(result1, _mm256_mul_ps(_mm256_shuffle_ps(m01, m01, 0xaa),
                            _mm256_broadcast_ps(&other.row[2].data)));
    result1 = _mm256_add_ps(result1, _mm256_mul_ps(_mm256_shuffle_ps(m01, m01, 0xff),
                            _mm256_broadcast_ps(&other.row[3].data)));
    ...
    result2 = _mm256_add_ps(result2, _mm256_mul_ps(_mm256_shuffle_ps(m23, m23, 0x55),
                            _mm256_broadcast_ps(&other.row[1].data)));
    result2 = _mm256_add_ps(result2, _mm256_mul_ps(_mm256_shuffle_ps(m23, m23, 0xaa),
                            _mm256_broadcast_ps(&other.row[2].data)));
    result2 = _mm256_add_ps(result2, _mm256_mul_ps(_mm256_shuffle_ps(m23, m23, 0xff),
                            _mm256_broadcast_ps(&other.row[3].data)));
